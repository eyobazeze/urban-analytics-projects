...
> _Who has access to public transport — and who is being left behind?_
...
_Left: 500m walkability buffers around transit stops overlaid on population density. Right: Served vs. underserved areas, with high-density underserved zones highlighted in red._
...
> **Note:** The current version uses a synthetic population density grid for demonstration. For production analysis, download the WorldPop Ethiopia 100m resolution raster and replace the grid generation step in `urban-analytics-projects.py`.
